...
# Name: SmartComputerGroupUpdate.sh
# Date: 04-23-2022
...
# Purpose: Updates smart computer group using group name and list of full names.
...
# Usage: SmartComputerGroupUpdate.sh "Smart_Computer_Group_Name" "/path/to/list/of/full/names"
